## DKYC server APIGW and DMSCORE log archive scripts:
...
- Insert below entry
  ```bash
  # apigw + dmscore log ariveing and moving to LOGS
  15 01 * * * /home/scripts/apigw-dmscore-log-archive.sh > /home/scripts/scripts_logs/dfs/apigw-dmscore-archive-scripts.log 2>&1
  ```
