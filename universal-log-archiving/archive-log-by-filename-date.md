...
SRC_DIR="/root/script/fake_logs"
#DEST_DIR="/LOGS/knotifypush-dmz/knotifypush-dmz1"
DEST_DIR="/root/script/out_logs"
COMPONENT="knotifydmzpush-ngd-dc1-kn-dmz-push01.nagad.com.bd-INST_1"
DAYS=3
LOCK_FILE="/tmp/knotifydmzpush01_archive.lock"
...
for file in "${COMPONENT}-"*.log.gz; do
